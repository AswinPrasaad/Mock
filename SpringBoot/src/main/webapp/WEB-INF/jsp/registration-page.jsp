...
<table align="center">
    <tr>
     ...
     <tr>
    	<td>Email*</td>
    	<td><input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}$" placeholder="xyz@something.com" required />
</td>
    	<td><p id="error2"></p></td>
    </tr>
    <tr>
    ...
    <tr><td align="right"><input type="submit" value="Submit" onclick="return valid()"/></td><td align="left"><input type="reset" value="Reset"/></td></tr>
    </table>
 </form:form>
</div>
</body>
